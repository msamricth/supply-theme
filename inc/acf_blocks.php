...
function register_supply_blocks() {
	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		...
		acf_register_block_type( array(
			...
			// 'align'				=> 'wide',
			'render_template'		=> 'templates/blocks/supply-split-block.php',
		));
		...
		acf_register_block_type( array(
			...
			'keywords'				=> array( 'supply', 'content', 'paragraph', 'text' ),
			'post_types'			=> array( 'post', 'page', 'case-studies', 'service-offerings', 'careers' ),
			'mode'					=> 'auto',
			// 'align'				=> 'wide',
		...
		/*
		// Register Supply Offerings Introduction Block
		acf_register_block_type(array(
			'name' => 'case-study-intro',
			'title' => 'Case Study Intro',
			'description' => 'Introduction Block for Case Studies',
		...
		*/
		...
		// Register Supply Motion Block
		acf_register_block_type( array(
			'name' 					=> 'supply-lottie-block',
			'title' 				=> __( 'Supply Motion Block (Lottie)' ),
			'description' 			=> __( 'Supply Motion Block - for use with indeign motion & Lottie files.' ),
			'category' 				=> 'supply-blocks',
			'icon'					=> 'video-alt',
			'keywords'				=> array( 'supply', 'lottie', 'motion', 'block', 'animations', 'svg' ),
			'post_types'			=> array( 'post', 'page', 'case-studies', 'service-offerings', 'careers' ),
			'mode'					=> 'auto',
