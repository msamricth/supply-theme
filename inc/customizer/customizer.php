 ...
 */
function supply_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'supply' ),
				'description' => __( 'Height: &gt;80px', 'supply' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'supply' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'supply' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'supply' ),
				'navbar-dark bg-primary' => __( 'Primary', 'supply' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'supply' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'supply' ),
				'fixed_top'    => __( 'Fixed to top', 'supply' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'supply' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'supply' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'supply_customize' );
